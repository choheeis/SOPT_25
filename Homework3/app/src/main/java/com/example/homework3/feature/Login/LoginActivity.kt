package com.example.homework3.feature.Login
...
import com.example.homework3.feature.GitFollowerView.FollowerActivity
import com.example.homework3.feature.Signup.SignupActivity
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if(requestCode == SIGNUP_REQUEST){
            if(resultCode == Activity.RESULT_OK){
                ...
                getIdPwFromIntent(data)
            }
        }
    }

    private fun getIdPwFromIntent(data: Intent?) {
